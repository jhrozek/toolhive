...
func TestConfigValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "no upstreams allowed for SPIFFE-only", config: Config{Issuer: "https://example.com", KeyProvider: validKeyProvider, HMACSecrets: validHMAC, AllowedAudiences: []string{"https://mcp.example.com"}}, wantErr: false},
