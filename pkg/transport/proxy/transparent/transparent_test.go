...
func TestStreamingSessionIDDetection(t *testing.T) {
	t.Parallel()
	proxy := NewTransparentProxy("127.0.0.1", 0, "", nil, nil, nil, nil, true, false, "streamable-http")
...
func TestNoSessionIDInNonSSE(t *testing.T) {
	...
	p := NewTransparentProxy("127.0.0.1", 0, "", nil, nil, nil, nil, false, false, "streamable-http")
...
func TestTracePropagationHeaders(t *testing.T) {
	...
	proxy := NewTransparentProxy("localhost", 0, downstream.URL, nil, nil, nil, nil, false, false, "")
...
func TestTransparentProxy_IdempotentStop(t *testing.T) {
	...
	// Create a proxy
	proxy := NewTransparentProxy("127.0.0.1", 0, "http://localhost:8080", nil, nil, nil, nil, false, false, "sse")
