...
// Package main is the entry point for the ToolHive SPIFFE Agent Proxy.
package main
...
import (
	...
	"github.com/stacklok/toolhive/cmd/thv-agent-proxy/app"
)
...
func main() {
	...
	// SIGQUIT, and os.Interrupt all trigger graceful shutdown.
